...
local JudgeCmds = {
	TapNoteScore_W1 = ((haishin=="Off") and THEME:GetMetric( "Judgment", "JudgmentW1Command" ) or THEME:GetMetric( "HaishinJudgment", "JudgmentW1Command" ));
	TapNoteScore_W2 = ((haishin=="Off") and THEME:GetMetric( "Judgment", "JudgmentW2Command" ) or THEME:GetMetric( "HaishinJudgment", "JudgmentW2Command" ));
	TapNoteScore_W3 = ((haishin=="Off") and THEME:GetMetric( "Judgment", "JudgmentW2Command" ) or THEME:GetMetric( "HaishinJudgment", "JudgmentW3Command" ));
	TapNoteScore_W4 = ((haishin=="Off") and THEME:GetMetric( "Judgment", "JudgmentW2Command" ) or THEME:GetMetric( "HaishinJudgment", "JudgmentW4Command" ));
	TapNoteScore_W5 = ((haishin=="Off") and THEME:GetMetric( "Judgment", "JudgmentW2Command" ) or THEME:GetMetric( "HaishinJudgment", "JudgmentW5Command" ));
	TapNoteScore_Miss = ((haishin=="Off") and THEME:GetMetric( "Judgment", "JudgmentMissCommand" ) or THEME:GetMetric( "HaishinJudgment", "JudgmentMissCommand" ));
};
