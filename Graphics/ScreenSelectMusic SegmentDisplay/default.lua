...
local SegmentTypes = {
	Stops	=	{ Frame = 0, xPos = iconSpace*0, yPos = 0 },
	Warps	=	{ Frame = 2, xPos = iconSpace*1, yPos = 0 },
	Delays	=	{ Frame = 1, xPos = iconSpace*2, yPos = 0 },
	Attacks	=	{ Frame = 6, xPos = iconSpace*3, yPos = 0 },
	Scrolls	=	{ Frame = 3, xPos = iconSpace*4, yPos = 0 },
	Speeds	=	{ Frame = 4, xPos = iconSpace*5, yPos = 0 },
	Fakes	=	{ Frame = 5, xPos = iconSpace*6, yPos = 0 },
};
...
local t = Def.ActorFrame{
	...
	LoadActor(iconPath)..{
		Name="WarpsIcon";
		InitCommand=cmd(blend,"BlendMode_Add";diffuse,Color("Blue");animate,false;x,SegmentTypes.Warps.xPos;y,SegmentTypes.Warps.yPos;setstate,SegmentTypes.Warps.Frame;diffusealpha,0);
		ShowCommand=showCmd;
		HideCommand=hideCmd;
	};
	LoadActor(iconPath)..{
		Name="StopsIcon";
		InitCommand=cmd(blend,"BlendMode_Add";diffuse,Color("Red");animate,false;x,SegmentTypes.Stops.xPos;y,SegmentTypes.Stops.yPos;setstate,SegmentTypes.Stops.Frame;diffusealpha,0);
		ShowCommand=showCmd;
		HideCommand=hideCmd;
	};
	LoadActor(iconPath)..{
